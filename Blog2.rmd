...
+ The data-set is  *OCHA Services: Data resposibility or COVID-19* taken from  [here](https://data.humdata.org/event/covid-19) which is being used for constructing this analysis. 
...
+ As it is so evident that those patients who are released are only rom age group "15-44" and "45-64". Above 64 none of the patients could make it from the COVID-19 infection. 
