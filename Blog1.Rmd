...
DT::datatable(Variable_Description, options = list(pageLength = 4))
...
DT::datatable(statistical_description, options = list(pageLength = 4))
...
# A graphical representation of the above table for a clear view
```{r}
